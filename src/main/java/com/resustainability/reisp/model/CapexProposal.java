...
public class CapexProposal {
	...
	private int id;
	private Long idVal;
	private String capex_title, department_name, user;
	private String capex_number, role_type;
	private String department, project_manager_fullname;
	private String business_unit, current_pending_at, total_available_budget_fy, lakhs;
	private String plant_code;
	private String requested_by_fullname, reject_remarks, send_back_remarks;
	private String head_of_plant_fullname;
	private String finance_fullname;
	private String regional_director_fullname;
	private String head_projects_fullname;
	private String finance_controller_fullname;
	private String business_head_fullname;
	private String cfo_fullname;
	private String ceo_fullname;
	private String plant_name;
	private String location, pendingAt, min_lakhs, max_lakhs, final_approver, previous_required_field;
	private String asset_description;
	private String status_previous;
	...
	public String getRequested_by_fullname() {
		return requested_by_fullname;
	}

	public void setRequested_by_fullname(String requested_by_fullname) {
		this.requested_by_fullname = requested_by_fullname;
	}

	public String getHead_of_plant_fullname() {
		return head_of_plant_fullname;
	}

	public void setHead_of_plant_fullname(String head_of_plant_fullname) {
		this.head_of_plant_fullname = head_of_plant_fullname;
	}

	public String getFinance_fullname() {
		return finance_fullname;
	}

	public void setFinance_fullname(String finance_fullname) {
		this.finance_fullname = finance_fullname;
	}

	public String getRegional_director_fullname() {
		return regional_director_fullname;
	}

	public void setRegional_director_fullname(String regional_director_fullname) {
		this.regional_director_fullname = regional_director_fullname;
	}

	public String getHead_projects_fullname() {
		return head_projects_fullname;
	}

	public void setHead_projects_fullname(String head_projects_fullname) {
		this.head_projects_fullname = head_projects_fullname;
	}

	public String getFinance_controller_fullname() {
		return finance_controller_fullname;
	}

	public void setFinance_controller_fullname(String finance_controller_fullname) {
		this.finance_controller_fullname = finance_controller_fullname;
	}

	public String getBusiness_head_fullname() {
		return business_head_fullname;
	}

	public void setBusiness_head_fullname(String business_head_fullname) {
		this.business_head_fullname = business_head_fullname;
	}

	public String getCfo_fullname() {
		return cfo_fullname;
	}

	public void setCfo_fullname(String cfo_fullname) {
		this.cfo_fullname = cfo_fullname;
	}

	public String getCeo_fullname() {
		return ceo_fullname;
	}

	public void setCeo_fullname(String ceo_fullname) {
		this.ceo_fullname = ceo_fullname;
	}

	public String getStatus_previous() {
		return status_previous;
	}

	public void setStatus_previous(String status_previous) {
		this.status_previous = status_previous;
	}
	...
	public String getLakhs() {
		return lakhs;
	}

	public void setLakhs(String lakhs) {
		this.lakhs = lakhs;
	}

	public String getMin_lakhs() {
		return min_lakhs;
	}

	public void setMin_lakhs(String min_lakhs) {
		this.min_lakhs = min_lakhs;
	}

	public String getMax_lakhs() {
		return max_lakhs;
	}

	public void setMax_lakhs(String max_lakhs) {
		this.max_lakhs = max_lakhs;
	}
	...
	public String getPrevious_required_field() {
		return previous_required_field;
	}

	public void setPrevious_required_field(String previous_required_field) {
		this.previous_required_field = previous_required_field;
	}
	...
	private String site_head_name, site_head_employee_id, site_head_email, site_finance_head_name,
			site_finance_head_designation, site_finance_head_employee_id, site_finance_head_email,
			finance_controller_comment, finance_controller_name, finance_controller_date,
			finance_controller_employee_id, finance_controller_email, regional_director_name,
			regional_director_employee_id, regional_director_email, bu_head_name, bu_head_employee_id, bu_head_email,
			project_head_name, project_head_employee_id, project_head_email, cfo_employee_id, cfo_email,
			ceo_employee_id, ceo_email;
	...
	public String getSend_back_remarks() {
		return send_back_remarks;
	}

	public void setSend_back_remarks(String send_back_remarks) {
		this.send_back_remarks = send_back_remarks;
	}
