...
.select2-container--classic .select2-selection--single .select2-selection__arrow b, .select2-container--default .select2-selection--single .select2-selection__arrow b {
    ...
    <meta name="description" content="Safety admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 RoleMaster with unlimited possibilities.">
    <meta name="keywords" content="admin template,RoleMaster, Safety admin template, dashboard template, flat admin template, responsive admin template, web app">
      ...
      <div class="content-wrapper container-xxl p-0">
        <div class="content-header row">
            ...
            <div class="row breadcrumbs-top">
              <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Role Masters </h2>
...
<div class="col-lg-4 col-sm-6 col-12"  style="box-sizing:border-box; display:table;">
  <div class="col-lg-3 col-sm-3 col-6"  style="padding: 1rem;display:table-cell;">
       <div class="col-md-12 mb-1">
              <select class="select2 form-select" id="select2-company_filter-container" name="incident_type" >
...
<div class="col-lg-2 col-sm-2 col-12"  style="box-sizing:border-box; display:table;">
    <div class="col-lg-3 col-sm-3 col-6"  style="padding: .5rem;display:table-cell;">
     <button class="btn btn-primary col-md-12" style="margin-top: 10px; width: 45%;     background-color: gainsboro"  onclick="getRoleMasterList();"><i class="fa fa-search" aria-hidden="true"></i></button>
  ...
  <div class="col-lg-6 col-sm-4 col-12"style="
    display: flex;
    align-items: end;
">
    <div class="col-lg-4 col-sm-6 col-6">
<!--     <button type="button" class="btn " data-bs-toggle="modal" data-bs-target="#addRoleMaster"style="margin-top: 17px; color: white !important; background-color: orange !important; width: 42%;"><i class="fa fa-add" aria-hidden="true"></i></button>
 -->         <button class="btn col-md-12" style="margin-top: 17px; width: 42%;     background-color: #14e014 !important;color: white !important;"  onclick="exportRoleMaster();"><i class="fa fa-download" aria-hidden="true"></i></button>
     </div>
...
<div class="modal fade" id="addRoleMaster" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body pb-5 px-sm-5 pt-50">
        <div class="text-center mb-2">
          <h1 class="mb-1">Add Role Master</h1>
        </div>
        <form id="addRoleMasterForm" class="row gy-1 pt-75" action="<%=request.getContextPath() %>/add-company" method="post" class="form-horizontal" role="form" >
        <div class="col-12 col-md-6">
            <label class="form-label" for="select2-basic">Incident Type</label><span class="required"> *</span>
            <select
            	class="select2 form-select formSelect" id="select2-incident_type_edit-container"  onchange="getLevelCount(this.value)"
              name="incident_type"
          ...
          <div class="col-12 col-md-6">
            <label class="form-label" for="modalEditUserLastName">Level </label><span class="required"> *</span>
            <input
              type="text"
              id="level_id"
              name="level"
            ...
            />
             <span id="incident_type_addError" class="error-msg" ></span>
          </div>
          <div class="col-12 text-center mt-2 pt-50">
            <button type="submit" class="btn btn-primary me-1" onclick="addRoleMaster();">Add</button>
