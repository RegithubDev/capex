...
.horizontal-menu .header-navbar.navbar-horizontal ul#main-menu-navigation>li.active>a {
    background: -webkit-linear-gradient(332deg, #e12228, rgba(225, 34, 40, .7))!important; ;
    background: linear-gradient(118deg, #30a63e, rgb(53 244 56 / 70%))!important; ;
    box-shadow: 0 0 6px 1px rgb(51 225 34 / 60%)!important; ;
    color: #FFF!important; ;
